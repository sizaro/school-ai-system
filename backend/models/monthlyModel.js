...
// ===============================
export const getServicesByMonth = async (startDate, endDate) => {
  const query = `
    SELECT 
...
// EXPENSES
// ===============================
export const getExpensesByMonth = async (startDate, endDate) => {
...
// SALARY ADVANCES
// ===============================
export const getAdvancesByMonth = async (startDate, endDate) => {
  const query = `
    SELECT 
      a.*,
      u.first_name,
...
// TAG FEES
// ===============================
export const getTagFeesByMonth = async (startDate, endDate) => {
  const query = `
...
// LATE FEES
// ===============================
export const getLateFeesByMonth = async (startDate, endDate) => {
  const query = `
