  ...
  return (
    <>
      ...
      <div className="md:hidden bg-blue-900 p-4 flex justify-between items-center text-white fixed top-0 left-0 right-0 z-50">
        <div>
          <div className="font-bold text-lg">Student Panel</div>
          <div className="text-xs text-blue-200">My School</div>
        </div>
      ...
      <aside className="hidden md:flex w-64 h-screen bg-blue-900 text-white fixed top-0 left-0 flex-col shadow-lg pt-16">
        ...
        <div className="px-6 mb-4">
          ...
          <p className="text-sm text-blue-200">My School</p>
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-2">
          <ul className="space-y-1 text-sm">
            ...
            <li>
              <Link
                to="/student/subjects"
                className={linkClass("/student/subjects")}
              >
                My Subjects
              </Link>
            </li>
